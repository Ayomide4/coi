...
export default function EventCountdown(){
    ...
    return (
      <div className="px-4 bg-background py-4 w-full min-h-[900px] relative ">
            <h1 className="text-5xl font-bold text-center">A NIGHT WHERE <span className="text-primary">WORSHIP</span> MEETS <span className="text-primary">TRUTH.</span></h1>
            ...
            <h1 className="text-4xl font-bold text-center my-5">191 days until the event</h1>
            <Button size={[22, 2.5]} text="Register Now" color="bg-backgroundGreen"/>
        </div>
    )
}