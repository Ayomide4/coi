  ...
  return (
    <div className="bg-background h-72 p-8 md:flex md:justify-center md:items-center">
      <div className="flex flex-col relative  z-20 md:w-full">
        ...
        <div className="absolute flex top-0  left-0 z-10 md:-top-8">
          <div className="w-0 h-0 rotate-90 border-l-[0px] border-r-[50px] border-b-[50px] border-b-secondary border-transparent opacity-80  md:border-r-[80px] md:border-b-[80px]"></div>
          <div className="w-0 h-0 rotate-90 border-l-[0px] border-r-[50px] border-b-[50px] border-b-secondary border-transparent opacity-80  md:border-r-[80px] md:border-b-[80px]"></div>
        </div>
