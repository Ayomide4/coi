...
export default function Navigation() {
  ...
  return (
    <nav className="absolute top-10 right-5 hidden md:block">
      <ul className="gap-4 text-xl font-light flex md:text-2xl">
        <li>
          <Link href="/" className="relative group">
            Home
            <span
              className={`absolute -bottom-1 left-0 w-full h-0.5 bg-white transform origin-left transition-transform duration-300 ease-out
